...
export const getUser = async (req, res) => { 
    ...
    try {
        ...
        return res.status(200).json(ApiResponse.success(200, 'Usuario obtenido con éxito', user));
    } catch (error) {
        console.error('Error al obtener usuario:', error);
        return res.status(500).json(ApiResponse.error(500, 'Error al obtener usuario', error));
    }
}
